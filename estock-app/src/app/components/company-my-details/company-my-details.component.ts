...
@Component({
  selector: 'app-company-my-details',
  templateUrl: './company-my-details.component.html',
  styleUrls: ['./company-my-details.component.css']
})
export class CompanyMyDetailsComponent implements OnInit {
